...
*/
    public partial class ATMSimulator : Form
    {
        ...
        private void takeCashOut_Click(object sender, EventArgs e)
        {
           // atm.dispWithdraw();
        }
        ...
        //updates text output of log information
        private void textBoxLogInfo_TextChanged(object sender, EventArgs e)
        {
            /*
